...
+ Run experiments on CIFAR100 - 5 tasks: python main.py --model dae --dataset seq-cifar100 --ablation op_cal --total_tasks 5 --num_aug 32 --norm_type bn_track_affine --lr 0.1 --lr_score 0.5 --temperature 0.1 --lamb 0.06_0.1 --buffer_size 2000 --dropout 0.0 --sparsity 0.8 --seed 0 --batch_size 32 --val_batch_size 256 --verbose
...
+ python main.py --model dae --cal --dataset seq-cifar100 --ablation op_cal --total_tasks 5 --num_aug 32 --norm_type bn_track_affine --lr 0.1 --lr_score 0.5 --temperature 0.1 --lamb 0.06_0.1 --buffer_size 2000 --dropout 0.0 --sparsity 0.8 --seed 0 --batch_size 32 --val_batch_size 256 --verbose
