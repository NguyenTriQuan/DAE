...
class DAE(ContinualModel):
    ...
    def fill_buffer(self, train_loader) -> None:
        ...
        for x, y, not_norm_x in loader:
            ...
            loss_ets = self.loss(outs_ets, y - (self.task-1) * self.dataset.N_CLASSES_PER_TASK, reduction=None).cpu()
            loss_kbts = self.loss(outs_kbts, y - (self.task-1) * self.dataset.N_CLASSES_PER_TASK, reduction=None).cpu()
